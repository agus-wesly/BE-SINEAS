...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("film-selling-price.update", [$filmSellingPrice->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
                    ...
                    <div>
                        ...
                        <div style="padding-left: 12px;padding-top: 8px;padding-bottom: 8px;padding-right: 12px">
                            <div class="form-group col">
                                ...
                                <input type="text"
                                       value="{{ old('name', $filmSellingPrice->name) }}"
                            ...
                            <div class="form-group col">
                                ...
                                <input type="number"
                                       value="{{ old('duration', $filmSellingPrice->duration) }}"
                            ...
                            <div class="form-group col">
                                ...
                                <input type="number"
                                       value="{{ old('price', $filmSellingPrice->price) }}"
